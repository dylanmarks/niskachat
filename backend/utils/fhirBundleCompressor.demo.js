...
console.log(
  "65-year-old female with Type 2 diabetes, hypertension, and hyperlipidemia",
);
console.log(
  "Recent labs, multiple medications, allergies, and preventive care",
);
console.log();
...
console.log(
  `- Resource Types: ${[...new Set(comprehensiveFHIRBundle.entry.map((e) => e.resource.resourceType))].join(", ")}`,
);
console.log(
  `- Original JSON Size: ${JSON.stringify(comprehensiveFHIRBundle, null, 2).length.toLocaleString()} characters`,
);
console.log();
...
console.log(
  `- Token Efficiency: ${Math.round(originalSize / estimatedTokens)}:1 ratio`,
);
console.log();
...
console.log(
  "The compressed summary maintains all clinically relevant information",
);
console.log(
  "while reducing token usage by " +
    compressionRatio +
    "% for cost-effective LLM interactions.",
);
